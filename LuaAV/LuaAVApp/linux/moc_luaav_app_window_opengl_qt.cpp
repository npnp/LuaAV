/****************************************************************************
** Meta object code from reading C++ file 'luaav_app_window_opengl_qt.h'
**
...
#error "The header file 'luaav_app_window_opengl_qt.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_OpenGLWindow[] = {
    "OpenGLWindow\0"
};

const QMetaObject OpenGLWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_OpenGLWindow,
      qt_meta_data_OpenGLWindow, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &OpenGLWindow::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OpenGLWindow))
